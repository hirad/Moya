    ...
    override func spec() {
        describe("an endpoint") {
            ...
            beforeEach {
                ...
                endpoint = Endpoint<GitHub>(URL: url(target), sampleResponseClosure: {.NetworkResponse(200, target.sampleData, nil)}, method: Moya.Method.GET, parameters: parameters, parameterEncoding: .JSON, httpHeaderFields: headerFields)
            }
